                                                    ...
                                                    return (
                                                        <Box key={index} onClick={() => navigate("/guestdetail", { state: { attendeeId: item.id } })}   >
                                                            ...
                                                            <Flex gap={10} sx={() => ({
                                                                ...
                                                                <Box p={3} sx={(theme) => ({ background: "#C2255C", borderRadius: "20px", color: "#fff", fontSize: "18px", fontWeight: "bold" })}><Text mx={10} sx={(theme) => ({ textAlign: "center" })}>wardee</Text></Box>
                                                            ...
                                                            <Box mt={20}  >
                                                                <Grid>
                                                                    ...
                                                                    <Grid.Col md={6} sm={6} sx={(theme) => ({ justifyContent: "center", alignItems: "center", })} >
                                                                        ...
                                                                        <Text sx={(theme) => ({ fontSize: "18px", fontWeight: "bold", })}>Check-In: {item.status === 1 ? <span style={{ color: "green" }}> Yes </span> : <span style={{ color: "red" }}>No</span>} </Text>                                                                  </Grid.Col>
                                                                </Grid>
